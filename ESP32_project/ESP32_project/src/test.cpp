...
// void initialRound(unsigned char state[16], unsigned char key[16]) {
//     addRoundKey(state,key);
// }

// void encryptMessage(unsigned char message[16]) {
...
// //         String tmp((const char*) paddedMessage+i, 16);
// //         res += encryptMessage(tmp);
// //     }
